...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Texte.html'
        db.alter_column(u'librairie_texte', 'html', self.gf('django.db.models.fields.TextField')(default='pf'))

    def backwards(self, orm):

        # Changing field 'Texte.html'
        db.alter_column(u'librairie_texte', 'html', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
